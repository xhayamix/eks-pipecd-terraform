resource "aws_iam_policy" "alb_controller_iam_policy" {
  ...
  description = "Allows access to ECR registry"
  policy      = jsonencode(
    {
      "Version": "2012-10-17",
      "Statement": [
...
resource "aws_iam_role_policy_attachment" "eks_custom_iam_role_policy_attachment" {
  role       = aws_iam_role.eks_iam_role.name
...
resource "aws_iam_role_policy_attachment" "eks_es2_role_policy_attachment" {
